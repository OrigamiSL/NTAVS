    ...
    def test(cls, cfg, model, evaluators=None):
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TEST):
            ...
            if dataset_name[:5] == 'avss_':
                results_i = inference_on_dataset_ss(model, data_loader, evaluator, cfg.OUTPUT_DIR, dataset_name, if_train=True)
            else:
                results_i = inference_on_dataset(model, data_loader, evaluator, cfg.OUTPUT_DIR, dataset_name, if_train=True)
