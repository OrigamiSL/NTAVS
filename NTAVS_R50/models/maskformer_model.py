...
class MaskFormer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        audio_backbone2: nn.Module or None,
        audio_backbone3: nn.Module or None,
        ...
        if backbone_name == 'build_pvtv2_b5_backbone':
            self.audio_backbone_linear = nn.Linear(768, 256)
    ...
    def from_config(cls, cfg):
        ...
        audio_backbone = build_CED(device, n_mels = 64, model_type= 'mini')
    ...
    def forward(self, batched_inputs):
        ...
        if self.early_fusion:
            ...
            outputs = self.sem_seg_head(features, audio_feature, frame_used = frame_used)  # dict {pred_logits, pred_masks, aux_outputs}
        ...
        if self.training:
            ...
            NTAVS_query_feat = outputs['NTAVS_query_feat']
            ...
            return processed_results, None, NTAVS_query_feat 
