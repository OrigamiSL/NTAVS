...
def _get_avss4_files(image_dir, gt_dir, audio_dir, pre_mask_dir=None, split="train",
    ...
    for category in categories:
        ...
        category_audio2_dir = os.path.join(audio2_dir, category)
        category_audio3_dir = os.path.join(audio3_dir, category)

        # print('category_img_dir',category_img_dir)
        ...
        for video in videos:
            ...
            audio2_file = os.path.join(category_audio2_dir, basenames[0][:-6] + ".pkl")
            audio3_file = os.path.join(category_audio3_dir, basenames[0][:-6] + ".pkl")
...
def register_avss4_semantic(root):
    ...
    for name, dirname in [("train", "train"), ("val", "val"), ("test", "test")]:
        ...
        DatasetCatalog.register(
            ...
            split=dirname: load_avss4_semantic(
